class mk.m11s.birds.Settings extends mk.m11s.base.Settings
  ...
  setupSounds : ->
    @track = 'assets/sounds/birds/track/Trees_short_005.mp3'
    @musicEvents = [
      #apparition maisons
      # nappe
      #apparition branches
    ...
    @sfx =
      ...
      house_show1 : 'MaisonApparait_1-1'
      house_show2 : 'MaisonApparait_1-2'
      house_show3 : 'MaisonApparait_1-3'
      branch1     : 'BrancheQuiPousse_PETITE_2'
      branch2     : 'BrancheQuiPousse_MOYENNE_1'
      bird1       : 'OiseauSenvole_GRAND_1'
      bird2       : 'OiseauSenvole_GRAND_2'
      bird3       : 'OiseauSenvole_MOYEN_1'
      lucioleloop : 'Luciolles_BOUCLE_1'